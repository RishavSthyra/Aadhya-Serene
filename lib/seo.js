...
export const staticSitemapRoutes = [
  ...
  { path: '/terms-and-conditions', changeFrequency: 'monthly', priority: 0.55 },
  { path: '/user-data-deletion', changeFrequency: 'monthly', priority: 0.55 },
  { path: '/project-overview', changeFrequency: 'weekly', priority: 0.9 },
