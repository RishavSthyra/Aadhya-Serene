...
const RENDERS_CDN = 'https://cdn.sthyra.com/AADHYA%20SERENE/renders';
...
export function flatVideoSrc(flatId, angle = 1) {
    return `${RENDERS_CDN}/flat_${flatId}_exterior_1-${angle}.webm`;
}
...
export function flatReverseVideoSrc(flatId) {
    return `${RENDERS_CDN}/reversed-flat_${flatId}_exterior_1-1.webm`;
}
...
export function preloadFlatEntryVideo(flatId) {
