...
const consultationNotes = [
  {
    icon: Building2,
    eyebrow: 'Residence Guidance',
    title: 'Inventory clarity without the usual back-and-forth.',
    copy: 'Ask about current availability, floor plans, finish details, and the residence that fits your pace of living.',
  },
  {
    icon: CalendarClock,
    eyebrow: 'Site Visit',
    title: 'Schedule a walkthrough at a time that suits you.',
    copy: 'Share your preferred window and our team will line up a smooth, guided visit to the project.',
  },
  {
    icon: BadgeCheck,
    eyebrow: 'Fast Response',
    title: 'A real team follows up with context, not canned replies.',
    copy: 'We send your enquiry straight to the project team so your next conversation starts informed.',
  },
];
...
const socialLinks = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/people/Aadhya-Serene/61584555298768/',
    icon: (
      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 320 512" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/aadhyaserene.apartments/',
    icon: (
      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" aria-hidden="true">
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@Aadhyaserene',
    icon: (
      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" aria-hidden="true">
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/aadhya-serene-21186639b',
    icon: (
      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" aria-hidden="true">
  ...
  {
    label: 'X',
    href: 'https://x.com/Abhignaconstruc',
    icon: (
...
export default function Contact() {
  ...
  async function handleSubmit(event) {
    ...
    setStatusMessage('Sending your enquiry to the project team...');
  ...
  return (
    <main className={styles.contactUs}>
      ...
      <div className={styles.contactUsWrapper}>
        <section className={styles.contactShowcase}>
          <form className={styles.contactUsForm} onSubmit={handleSubmit}>
            <div className={styles.formTop}>
              <div>
                ...
                <h2 className={`font-display ${styles.formTitle}`}>Tell us what you are looking for.</h2>
              </div>
            </div>
            ...
            <div className={styles.formGrid}>
              ...
              <div className={`${styles.inputGroup} ${styles.fullWidthField}`}>
                <label htmlFor="preferredTime">Preferred Call or Visit Window</label>
                <input
                  id="preferredTime"
                  name="preferredTime"
            ...
            <div className={styles.formActions}>
              ...
              >
                <span>{submitState === 'sending' ? 'Sending Enquiry' : 'Send Enquiry'}</span>
                <Send size={16} strokeWidth={1.8} />
              </button>

              <div className={styles.assurance}>
                <ArrowRight size={15} strokeWidth={1.8} />
                <span>Direct delivery to the project inbox. No lost leads, no placeholder form.</span>
              </div>
            </div>

            <div className={styles.disclaimer}>
              By submitting this form, you consent to your enquiry being shared with the Aadhya Serene sales team
              for follow-up regarding availability, pricing, brochures, and site visits.
            </div>
          </form>
        </section>
        ...
        <footer className={styles.contactFooter}>
          <div className={styles.footerMainRow}>
            <div className={styles.footerInfoColumn}>
              ...
              <span className={styles.footerCopy}>Copyright 2026 Aadhya Serene. All rights reserved.</span>
              ...
              <div className={styles.footerContactRow}>
                ...
                <a href="mailto:sales@abhignaconstructions.com" className={styles.footerLink}>
